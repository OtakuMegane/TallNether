...
public class ConfigValues {
    ...
    public ConfigValues(String worldName, ConfigurationSection worldConfig) {
        ...
        this.generateFortress = this.worldConfig.getBoolean("generate-fortress", true);
        ...
        this.flatBedrockCeiling = this.worldConfig.getBoolean("flat-bedrock-ceiling", false);
        this.flatBedrockFloor = this.worldConfig.getBoolean("flat-bedrock-floor", false);
    };
