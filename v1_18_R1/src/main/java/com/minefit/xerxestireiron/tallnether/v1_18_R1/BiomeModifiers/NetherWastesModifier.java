...
public class NetherWastesModifier extends BiomeModifier {
    ...
    private BiomeGenerationSettings createModifiedSettings() {
        ...
        // data.worldgen.biome.NetherBiomes.netherWastes
        ...
        biomeGenerationSettings_builder.addFeature(Decoration.UNDERGROUND_DECORATION, NetherPlacements.GLOWSTONE_EXTRA);
        biomeGenerationSettings_builder.addFeature(Decoration.UNDERGROUND_DECORATION, NetherPlacements.GLOWSTONE);
