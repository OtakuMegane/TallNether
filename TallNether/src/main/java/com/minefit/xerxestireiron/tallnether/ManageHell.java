...
public class ManageHell {
    ...
    private com.minefit.xerxestireiron.tallnether.v1_18_R1.LoadHell LH17R1;
    private com.minefit.xerxestireiron.tallnether.v1_18_R1.LoadHell LH18R1;
    ...
    public void overrideGenerator(World world) {
        ...
        if (this.plugin.version.equals("v1_12_R1")) {
            ...
            if (this.LH17R1 == null) {
                this.LH17R1 = new com.minefit.xerxestireiron.tallnether.v1_18_R1.LoadHell(worldConfig,
                        this.plugin.isPaper(), this.plugin.getName());
            }
            ...
            if (this.LH18R1 == null) {
                this.LH18R1 = new com.minefit.xerxestireiron.tallnether.v1_18_R1.LoadHell(worldConfig,
                        this.plugin.isPaper(), this.plugin.getName());
            }

            this.LH18R1.addWorld(world, worldConfig);
            this.LH18R1.overrideGenerator(world);
        }
    }
    ...
    public void restoreGenerator(World world) {
        if (this.plugin.version.equals("v1_12_R1")) {
            ...
            this.LH17R1.restoreGenerator(world);
        }
    }
