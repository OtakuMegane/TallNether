...
import net.minecraft.server.v1_9_R1.BlockPortal;
...
import net.minecraft.server.v1_9_R1.PortalTravelAgent;
...
public class TallNether_CraftTravelAgent extends CraftTravelAgent implements TravelAgent {
    ...
    public BlockPosition findPortal(double x, double y, double z, int radius) {
                ...
                for (int i1 = -radius; i1 <= radius; ++i1) {
                    for (BlockPosition blockposition2 = blockposition.a(l, 256 - 1 - blockposition.getY(),
                        ...
                        if (this.world.getType(blockposition2).getBlock() == Blocks.PORTAL) {
                            while (this.world.getType(blockposition1 = blockposition2.down())
        ...
        if (d0 >= 0.0D) {
            if (flag1) {
                this.c.put(k,
                        new PortalTravelAgent.ChunkCoordinatesPortal((BlockPosition) object, this.world.getTime()));
