...
public final class TallNether_ChunkGeneratorAbstract extends ChunkGenerator {
    public static final Codec<TallNether_ChunkGeneratorAbstract> d = RecordCodecBuilder.create((instance) -> {
        ...
        })).apply(instance, instance.stable(TallNether_ChunkGeneratorAbstract::new));
    });
    ...
    public TallNether_ChunkGeneratorAbstract(WorldChunkManager worldchunkmanager, long i,
            GeneratorSettingBase generatorsettingbase) {
        this(null, worldchunkmanager, worldchunkmanager, i, generatorsettingbase);
    }

    public TallNether_ChunkGeneratorAbstract(World world, WorldChunkManager worldchunkmanager, long i,
            GeneratorSettingBase generatorsettingbase) {
        this(world, worldchunkmanager, worldchunkmanager, i, generatorsettingbase);
    }

    private TallNether_ChunkGeneratorAbstract(World world, WorldChunkManager worldchunkmanager,
            WorldChunkManager worldchunkmanager1, long i, GeneratorSettingBase generatorsettingbase) {
        ...
        // TallNether: this.x originally set from noisesettings.a() which returns 128
        this.x = 256;
        ...
        this.n = 16 / this.m;
        // TallNether: this.o originally set from noisesettings.a() / this.l
        this.o = 256 / this.l;
        this.p = 16 / this.m;
        ...
        this.t = (NoiseGenerator) (noisesettings.i() ? new NoiseGenerator3(this.e, IntStream.rangeClosed(-3, 0))
        ...
        for (int l = 0; l < 16; ++l) {
            ...
            if (l < 8) {
                ...
                if (noisegeneratorperlin2 != null) {
                    d6 += noisegeneratorperlin2.a(NoiseGeneratorOctaves.a((double) i * d2 * d7),
                            NoiseGeneratorOctaves.a((double) j * d3 * d7),
                            NoiseGeneratorOctaves.a((double) k * d2 * d7), d3 * d7, (double) j * d3 * d7) / d7;
                }
            }
        ...
        if (this.v != null) {
            ...
            for (int l = -2; l <= 2; ++l) {
                for (int i1 = -2; i1 <= 2; ++i1) {
                    ...
                    float f9 = f8 * TallNether_ChunkGeneratorAbstract.j[l + 2 + (i1 + 2) * 5] / (f6 + 2.0F);
    ...
    protected IBlockData a(double d0, int i) {
        ...
        if (d0 > 0.0D) {
            ...
            iblockdata = TallNether_ChunkGeneratorAbstract.k;
        }
    ...
    public void buildBase(RegionLimitedWorldAccess regionlimitedworldaccess, IChunkAccess ichunkaccess) {
        ...
        for (int i1 = 0; i1 < 16; ++i1) {
            for (int j1 = 0; j1 < 16; ++j1) {
                ...
                double d1 = this.t.a((double) k1 * 0.0625D, (double) l1 * 0.0625D, 0.0625D, (double) i1 * 0.0625D)
                        * 15.0D;

                regionlimitedworldaccess.getBiome(blockposition_mutableblockposition.d(k + i1, i2, l + j1)).a(
                        ...
                        while (iterator1.hasNext()) {
                            ...
                            if (structurepiece.a(chunkcoordintpair, 12)) {
                                if (structurepiece instanceof WorldGenFeaturePillagerOutpostPoolPiece) {
                                    ...
                                    WorldGenFeatureDefinedStructurePoolTemplate.Matching worldgenfeaturedefinedstructurepooltemplate_matching = worldgenfeaturepillageroutpostpoolpiece
                                            .b().e();
                        ...
                        for (int i3 = 0; i3 < this.m; ++i3) {
                            ...
                            for (int l3 = 0; l3 < this.m; ++l3) {
                                ...
                                while (objectlistiterator1.hasNext()) {
                                    WorldGenFeatureDefinedStructureJigsawJunction worldgenfeaturedefinedstructurejigsawjunction = (WorldGenFeatureDefinedStructureJigsawJunction) objectlistiterator1
                                            .next();
                                ...
                                if (iblockdata != TallNether_ChunkGeneratorAbstract.k) {
                                    if (iblockdata.f() != 0) {
    ...
    private static double a(int i, int j, int k) {
        ...
        return l >= 0 && l < 24 ? (i1 >= 0 && i1 < 24
                ? (j1 >= 0 && j1 < 24 ? (double) TallNether_ChunkGeneratorAbstract.i[j1 * 24 * 24 + l * 24 + i1] : 0.0D)
                : 0.0D) : 0.0D;
    }
    ...
    @Override
    public List<BiomeBase.BiomeMeta> getMobsFor(BiomeBase biomebase, StructureManager structuremanager,
