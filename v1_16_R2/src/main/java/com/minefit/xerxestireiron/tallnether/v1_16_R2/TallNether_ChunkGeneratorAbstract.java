...
public final class TallNether_ChunkGeneratorAbstract extends ChunkGenerator {
    ...
    public TallNether_ChunkGeneratorAbstract(WorldChunkManager worldchunkmanager, long i,
            Supplier<GeneratorSettingBase> supplier) {
        this(null, worldchunkmanager, worldchunkmanager, i, supplier);
    }

    public TallNether_ChunkGeneratorAbstract(World world, WorldChunkManager worldchunkmanager, long i,
            Supplier<GeneratorSettingBase> supplier) {
        this(world, worldchunkmanager, worldchunkmanager, i, supplier);
    }

    private TallNether_ChunkGeneratorAbstract(World world, WorldChunkManager worldchunkmanager,
            WorldChunkManager worldchunkmanager1, long i, Supplier<GeneratorSettingBase> supplier) {
    ...
    private double a(int i, int j, int k, double d0, double d1, double d2, double d3) {
        ...
        // TallNether: We inject a multiplier to force the integer overflow
        int iMultiX = 1;
        int kMultiZ = 1;
    ...
    private static double a(int i, int j, int k) {
        ...
        return l >= 0 && l < 24 ? (i1 >= 0 && i1 < 24 ? (j1 >= 0 && j1 < 24 ? (double) TallNether_ChunkGeneratorAbstract.i[j1 * 24 * 24 + l * 24 + i1] : 0.0D) : 0.0D) : 0.0D;
    }
