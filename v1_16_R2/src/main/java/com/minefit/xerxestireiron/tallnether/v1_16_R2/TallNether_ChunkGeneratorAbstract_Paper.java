...
public final class TallNether_ChunkGeneratorAbstract_Paper extends ChunkGenerator {
    ...
    public TallNether_ChunkGeneratorAbstract_Paper(WorldChunkManager worldchunkmanager, long i,
            Supplier<GeneratorSettingBase> supplier) {
        this(null, worldchunkmanager, worldchunkmanager, i, supplier);
    }

    public TallNether_ChunkGeneratorAbstract_Paper(World world, WorldChunkManager worldchunkmanager, long i,
            Supplier<GeneratorSettingBase> supplier) {
        this(world, worldchunkmanager, worldchunkmanager, i, supplier);
    }

    private TallNether_ChunkGeneratorAbstract_Paper(World world, WorldChunkManager worldchunkmanager,
    ...
    protected Codec<? extends ChunkGenerator> a() {
        return TallNether_ChunkGeneratorAbstract_Paper.d;
    }
