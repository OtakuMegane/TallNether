...
public class BiomeValues {
    ...
    private final ConfigurationSection biomeConfig;
    ...
    public BiomeValues(ConfigurationSection biomeConfig, Map<String, Boolean> paperConfig) {
        ...
        this.generateFortress = this.biomeConfig.getBoolean("generate-fortress",
        ...
        this.generateGravel = this.biomeConfig.getBoolean("generate-gravel", true);
        this.generateSoulsand = this.biomeConfig.getBoolean("generate-soulsand", true);
    ...
    private int setDecoration(String setting, int defaultValue, boolean safetyMax) {
        int value = this.biomeConfig.getInt(setting, defaultValue);
