...
public class BiomeCrimsonForest extends BiomeValues {

    // Vanilla
    public BiomeCrimsonForest(Map<String, Boolean> paperConfig) {
        super(paperConfig);
        ...
        values.put("gravel-patch-max-offset", 5);
        values.put("blackstone-patch-attempts", 2);
        values.put("blackstone-patch-min-height", 5);
        values.put("blackstone-patch-max-height", 37);
        values.put("blackstone-patch-max-offset", 5);
        this.values = Collections.unmodifiableMap(values);
    }

    public BiomeCrimsonForest(ConfigurationSection biomeConfig, Map<String, Boolean> paperConfig) {
        super(biomeConfig, paperConfig);
        Map<String, Integer> values = new HashMap<>();
        values.put("lavafall-attempts", setDecoration("lavafall-attempts", 16, false));
