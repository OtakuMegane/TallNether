...
public class BiomeSoulSandValley extends BiomeValues {

    // Vanilla
    public BiomeSoulSandValley(Map<String, Boolean> paperConfig) {
        super(paperConfig);
    ...
    public BiomeSoulSandValley(ConfigurationSection biomeConfig, Map<String, Boolean> paperConfig) {
