...
public final class TallNether_BiomeHell extends BiomeBase {
    ...
    protected TallNether_BiomeHell() {
        ...
        this.a((StructureGenerator) WorldGenerator.p, (WorldGenFeatureConfiguration) (new WorldGenNetherConfiguration()));
        this.a(WorldGenStage.Features.AIR, a((WorldGenCarver) TallNether_BiomeHell.c, (WorldGenFeatureConfiguration) (new WorldGenFeatureConfigurationChance(0.2F))));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.at, new WorldGenFeatureFlowingConfiguration(FluidTypes.e), TallNether_BiomeHell.w, new WorldGenFeatureChanceDecoratorCountConfiguration(20, 8, 16, 256)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ah, new WorldGenFeatureMushroomConfiguration(Blocks.BROWN_MUSHROOM), TallNether_BiomeHell.q, new WorldGenDecoratorChanceConfiguration(4)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ah, new WorldGenFeatureMushroomConfiguration(Blocks.RED_MUSHROOM), TallNether_BiomeHell.q, new WorldGenDecoratorChanceConfiguration(8)));
        this.a(WorldGenStage.Decoration.UNDERGROUND_DECORATION, a(WorldGenerator.p, new WorldGenNetherConfiguration(), TallNether_BiomeHell.n, WorldGenFeatureDecoratorConfiguration.e));
        this.a(WorldGenStage.Decoration.UNDERGROUND_DECORATION, a(WorldGenerator.ak, new WorldGenFeatureHellFlowingLavaConfiguration(false), TallNether_BiomeHell.u, new WorldGenFeatureChanceDecoratorCountConfiguration(8, 4, 8, 128)));
        ...
        this.a(WorldGenStage.Decoration.UNDERGROUND_DECORATION, a(WorldGenerator.ak, new WorldGenFeatureHellFlowingLavaConfiguration(true), TallNether_BiomeHell.u, new WorldGenFeatureChanceDecoratorCountConfiguration(16, 10, 20, 128)));
    }
}
