                            ...
                            if (d9 > -0.7D && d7 * d7 + d9 * d9 + d8 * d8 < 1.0D) {
                                ...
                                if (!bitset.get(k3)) {
                                    ...
                                    if (this.a(generatoraccess.getType(new BlockPosition(k2, j3, i3)))) {
                                        if (j3 <= 47) {
                                            generatoraccess.setTypeAndData(new BlockPosition(k2, j3, i3), TallNether_WorldGenCavesHell.d.i(), 2);
                                        } else {
                                            generatoraccess.setTypeAndData(new BlockPosition(k2, j3, i3), TallNether_WorldGenCavesHell.b, 2);
                                        }
