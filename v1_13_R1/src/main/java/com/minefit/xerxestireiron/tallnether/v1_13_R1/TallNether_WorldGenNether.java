...
public class TallNether_WorldGenNether extends WorldGenNether {
    ...
    public static class a extends StructureStart {
        ...
        public a(GeneratorAccess generatoraccess, SeededRandom seededrandom, int i, int j, BiomeBase biomebase) {
            ...
            int min = this.configAccessor.getConfig(worldName).fortressMin > 210 ? 210 : this.configAccessor.getConfig(worldName).fortressMin;
            int max = this.configAccessor.getConfig(worldName).fortressMax > 210 ? 210 : this.configAccessor.getConfig(worldName).fortressMax;
